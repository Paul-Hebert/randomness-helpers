...
<p>
  You can generate a completely random color, or pass in an object with optional <code
    >h</code
  >, <code>s</code>, <code>l</code>, and <code>a</code> properties. (For hue, saturation,
  lightness, and alpha (transparency.))
</p>
<p>
